...
- Ensure `repos`, `tasks`, and analytics commands accept `--json` outputs for scripting.
  Coverage spans `tests/test_repo_manager.py::test_main_list_supports_json_output`,
  `tests/test_task_manager.py::test_main_list_supports_json_output`,
  `tests/test_cli.py::test_cli_repos_list_json`,
  `tests/test_cli.py::test_cli_tasks_list_json`, and
  `tests/test_critic.py::test_cli_commands` for analytics JSON output.
